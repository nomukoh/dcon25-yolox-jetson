...
DEFAULT_DEVICE_INDEX = 2  # Set this to your desired audio input device index
...
def record_audio(duration=2, wave_filename="recorded.wav"):
    ...
    channels = 1  # Adjust dynamically based on device capabilities
    fs = 16000
    ...
    try:
        ...
        if channels > max_channels:
            channels = max_channels  # Adjust to supported channel count
